package com.shiin.music.activity;
...
import com.shiin.music.databinding.ActivityMainBinding;
import com.shiin.music.fragment.AdminFeedbackFragment;
import com.shiin.music.fragment.AdminHomeFragment;
import com.shiin.music.fragment.AllSongsFragment;
import com.shiin.music.fragment.ChangePasswordFragment;
import com.shiin.music.fragment.ContactFragment;
import com.shiin.music.fragment.FavoriteFragment;
import com.shiin.music.fragment.FeaturedSongsFragment;
import com.shiin.music.fragment.FeedbackFragment;
import com.shiin.music.fragment.HomeFragment;
import com.shiin.music.fragment.NewSongsFragment;
import com.shiin.music.fragment.PopularSongsFragment;
import com.shiin.music.model.Song;
import com.shiin.music.model.User;
import com.shiin.music.prefs.DataStoreManager;
import com.shiin.music.service.MusicService;
...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.layout_close) {
            ...
            mActivityMainBinding.drawerLayout.closeDrawer(GravityCompat.START);
            openNewSongsScreen();
        } else if (id == R.id.tv_menu_favorite_songs) {
            mActivityMainBinding.drawerLayout.closeDrawer(GravityCompat.START);
            ...
            mActivityMainBinding.drawerLayout.closeDrawer(GravityCompat.START);
            openContactScreen();
        } else if (id == R.id.tv_menu_change_password) {
            mActivityMainBinding.drawerLayout.closeDrawer(GravityCompat.START);
            openChangePasswordScreen();
        } else if (id == R.id.tv_menu_sign_out) {
            onClickSignOut();
