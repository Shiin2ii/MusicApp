...
import com.shiin.music.databinding.ItemSongGridBinding;
...
public class SongGridAdapter extends RecyclerView.Adapter<SongGridAdapter.SongGridViewHolder> {
    ...
    public void onBindViewHolder(@NonNull SongGridViewHolder holder, int position) {
        ...
        String strListen = song.getCount() > 1 ? 
            holder.mItemSongGridBinding.getRoot().getContext().getString(R.string.listen_plural) : 
            holder.mItemSongGridBinding.getRoot().getContext().getString(R.string.listen_single);
